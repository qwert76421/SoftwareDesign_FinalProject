...
public abstract class Level implements Bundlable {
	...
	private static final String VERSION = LevelBundleKeys.VERSION;
	private static final String WIDTH = LevelBundleKeys.WIDTH;
	private static final String HEIGHT = LevelBundleKeys.HEIGHT;
	private static final String MAP = LevelBundleKeys.MAP;
	private static final String VISITED = LevelBundleKeys.VISITED;
	private static final String MAPPED = LevelBundleKeys.MAPPED;
	private static final String TRANSITIONS = LevelBundleKeys.TRANSITIONS;
	private static final String LOCKED = LevelBundleKeys.LOCKED;
	private static final String HEAPS = LevelBundleKeys.HEAPS;
	private static final String PLANTS = LevelBundleKeys.PLANTS;
	private static final String TRAPS = LevelBundleKeys.TRAPS;
	private static final String CUSTOM_TILES = LevelBundleKeys.CUSTOM_TILES;
	private static final String CUSTOM_WALLS = LevelBundleKeys.CUSTOM_WALLS;
	private static final String MOBS = LevelBundleKeys.MOBS;
	private static final String BLOBS = LevelBundleKeys.BLOBS;
	private static final String FEELING = LevelBundleKeys.FEELING;
	...
	public void restoreFromBundle(Bundle bundle) {
		...
		if (bundle.contains(LevelBundleKeys.MOBS_TO_SPAWN)) {
			for (Class<? extends Mob> mob : bundle.getClassArray(LevelBundleKeys.MOBS_TO_SPAWN)) {
				if (mob != null)
					mobsToSpawn.add(mob);
			}
		}

		if (bundle.contains(LevelBundleKeys.RESPAWNER)) {
			respawner = (MobSpawner) bundle.get(LevelBundleKeys.RESPAWNER);
		}
	...
	public void storeInBundle(Bundle bundle) {
		...
		bundle.put(LevelBundleKeys.MOBS_TO_SPAWN, mobsToSpawn.toArray(new Class[0]));

		// bundle.put("respawner", respawner);
		bundle.put(LevelBundleKeys.RESPAWNER, respawner);
	}
	...
	public static void set(LevelCell cell, TerrainId terrain) {
		set(cell.index(), terrain.id());
	}

	public static void set(LevelCell cell, TerrainId terrain, Level level) {
		set(cell.index(), terrain.id(), level);
	}
	...
	public String tileName(TerrainId tile) {
		return tileName(tile.id());
	}
	...
	public String tileDesc(TerrainId tile) {
		return tileDesc(tile.id());
	}
