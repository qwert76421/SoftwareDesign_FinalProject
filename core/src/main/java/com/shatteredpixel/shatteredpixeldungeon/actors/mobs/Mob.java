...
public abstract class Mob extends Char {
	...
	public CharSprite sprite() {
		...
		// 先走原本機制（向下相容：現有 mob 若已設定 spriteClass，不受影響）
		Class<? extends CharSprite> sc = spriteClass;

		// 如果某個 mob 忘了設 spriteClass，就改用集中式 registry
		if (sc == null) {
			sc = MobSpriteRegistry.spriteClassFor(getClass());
		}

		return Reflection.newInstance(sc);
	}
